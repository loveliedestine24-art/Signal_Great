...
st.markdown("""<style>.stApp { background-color: #050505; color: white; } .signal-call { padding: 20px; border-radius: 10px; background-color: #0b2e13; border: 2px solid #28a745; text-align: center; } .signal-put { padding: 20px; border-radius: 10px; background-color: #2c0b0e; border: 2px solid #dc3545; text-align: center; }</style>""", unsafe_allow_index=True)
